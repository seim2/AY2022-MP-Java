...
public final class MP2Test {
  ...
  public static class UnitTests {
    ...
    public void test0_ServerFavoritePlacePost() throws IOException {
      ...
      System.out.println("aaaaaaaa: " + allPlaces);
...
/*
      ...
      Request invalidRequest3 =
          new Request.Builder()
              .url(FavoritePlacesApplication.SERVER_URL + "/favoriteplace/")
              .post(
                  RequestBody.create(
                      "{\"cats\":\n\"true\"}", MediaType.parse("application/json; charset=utf-8")))
              .build();
      Response invalidResponse3 = httpClient.newCall(invalidRequest3).execute();
      assertWithMessage("Request should not have succeeded")
 ...
 */
  ...
  public static class IntegrationTests {
    ...
    private void clientPostPlace(final Place place, boolean shouldThrow)
      ...
      if (!shouldThrow) {
        ...
        assertWithMessage("postFavoritePlace didn't throw an exception")
            .that(result.getException())
            .isNotNull();
      }
    }
    ...
    public void test1_ClientFavoritePlacePost()
      ...
      Place invalidPlace = Helpers.makePlaceFromJson("not-a-uuid", "namename", 888.8, -888.8, "");
...
// md5: a7373c3e4dcd104a8929ce59b36ce8f3
